 ...
 * @see com.liferay.software.catalog.service.persistence.impl.SCProductVersionPersistenceImpl
 * @generated
 */
@ProviderType
public class SCProductVersionUtil {
	...
	* @throws com.liferay.software.catalog.NoSuchProductVersionException if a matching s c product version could not be found
	*/
	public static SCProductVersion findByProductEntryId_First(
		long productEntryId,
		OrderByComparator<SCProductVersion> orderByComparator)
		throws com.liferay.software.catalog.exception.NoSuchProductVersionException {
		return getPersistence()
	...
	* @throws com.liferay.software.catalog.NoSuchProductVersionException if a s c product version with the primary key could not be found
	*/
	...
	*/
	...
	/**
	* Returns the s c product version where directDownloadURL = &#63; or throws a {@link com.liferay.software.catalog.NoSuchProductVersionException} if it could not be found.
	*
	...
	*/
	...
	/**
	* Returns the s c product version with the primary key or throws a {@link com.liferay.software.catalog.NoSuchProductVersionException} if it could not be found.
	*
	* @param productVersionId the primary key of the s c product version
	...
	*/
	public static List<com.liferay.software.catalog.model.SCFrameworkVersion> getSCFrameworkVersions(
		long pk) {
	...
	*/
	public static List<com.liferay.software.catalog.model.SCFrameworkVersion> getSCFrameworkVersions(
		long pk, int start, int end,
		OrderByComparator<com.liferay.software.catalog.model.SCFrameworkVersion> orderByComparator) {
		return getPersistence()
	...
	*/
	public static void addSCFrameworkVersions(long pk,
		List<com.liferay.software.catalog.model.SCFrameworkVersion> scFrameworkVersions) {
	...
	*/
	...
	private static ServiceTracker<SCProductVersionPersistence, SCProductVersionPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(SCProductVersionUtil.class);

		_serviceTracker = new ServiceTracker<SCProductVersionPersistence, SCProductVersionPersistence>(bundle.getBundleContext(),
				SCProductVersionPersistence.class, null);
