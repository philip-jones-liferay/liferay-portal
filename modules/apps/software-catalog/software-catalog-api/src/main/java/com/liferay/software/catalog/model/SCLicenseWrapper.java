...
public class SCLicenseWrapper implements SCLicense, ModelWrapper<SCLicense> {
	...
	@Override
	public int compareTo(com.liferay.software.catalog.model.SCLicense scLicense) {
	...
	*/
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.liferay.software.catalog.model.SCLicense> toCacheModel() {
		return _scLicense.toCacheModel();
	}

	@Override
	public com.liferay.software.catalog.model.SCLicense toEscapedModel() {
	...
	@Override
	public com.liferay.software.catalog.model.SCLicense toUnescapedModel() {
