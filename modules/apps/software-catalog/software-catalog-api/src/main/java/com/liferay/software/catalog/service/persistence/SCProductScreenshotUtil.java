...
package com.liferay.software.catalog.service.persistence;
 ...
 * @see com.liferay.software.catalog.service.persistence.impl.SCProductScreenshotPersistenceImpl
 * @generated
 */
@ProviderType
public class SCProductScreenshotUtil {
	...
	* @throws com.liferay.software.catalog.NoSuchProductScreenshotException if a matching s c product screenshot could not be found
	*/
	public static SCProductScreenshot findByProductEntryId_First(
		long productEntryId,
		OrderByComparator<SCProductScreenshot> orderByComparator)
		throws com.liferay.software.catalog.exception.NoSuchProductScreenshotException {
		return getPersistence()
	...
	* @throws com.liferay.software.catalog.NoSuchProductScreenshotException if a s c product screenshot with the primary key could not be found
	*/
	...
	*/
	...
	/**
	* Returns the s c product screenshot where thumbnailId = &#63; or throws a {@link com.liferay.software.catalog.NoSuchProductScreenshotException} if it could not be found.
	*
	...
	*/
	...
	/**
	* Returns the s c product screenshot where fullImageId = &#63; or throws a {@link com.liferay.software.catalog.NoSuchProductScreenshotException} if it could not be found.
	*
	...
	*/
	...
	/**
	* Returns the s c product screenshot where productEntryId = &#63; and priority = &#63; or throws a {@link com.liferay.software.catalog.NoSuchProductScreenshotException} if it could not be found.
	*
	* @param productEntryId the product entry ID
	...
	*/
	...
	/**
	* Returns the s c product screenshot with the primary key or throws a {@link com.liferay.software.catalog.NoSuchProductScreenshotException} if it could not be found.
	*
	* @param productScreenshotId the primary key of the s c product screenshot
	...
	*/
	...
	private static ServiceTracker<SCProductScreenshotPersistence, SCProductScreenshotPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(SCProductScreenshotUtil.class);

		_serviceTracker = new ServiceTracker<SCProductScreenshotPersistence, SCProductScreenshotPersistence>(bundle.getBundleContext(),
				SCProductScreenshotPersistence.class, null);
