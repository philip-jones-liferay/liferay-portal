 ...
 * @see com.liferay.software.catalog.service.persistence.impl.SCFrameworkVersionPersistenceImpl
 * @generated
 */
@ProviderType
public class SCFrameworkVersionUtil {
	...
	* @throws com.liferay.software.catalog.NoSuchFrameworkVersionException if a matching s c framework version could not be found
	*/
	public static SCFrameworkVersion findByGroupId_First(long groupId,
		OrderByComparator<SCFrameworkVersion> orderByComparator)
		throws com.liferay.software.catalog.exception.NoSuchFrameworkVersionException {
	...
	* @throws com.liferay.software.catalog.NoSuchFrameworkVersionException if a s c framework version with the primary key could not be found
	*/
	...
	*/
	...
	/**
	* Returns the s c framework version with the primary key or throws a {@link com.liferay.software.catalog.NoSuchFrameworkVersionException} if it could not be found.
	*
	* @param frameworkVersionId the primary key of the s c framework version
	...
	*/
	public static List<com.liferay.software.catalog.model.SCProductVersion> getSCProductVersions(
		long pk) {
	...
	*/
	public static List<com.liferay.software.catalog.model.SCProductVersion> getSCProductVersions(
		long pk, int start, int end,
		OrderByComparator<com.liferay.software.catalog.model.SCProductVersion> orderByComparator) {
		return getPersistence()
	...
	*/
	public static void addSCProductVersions(long pk,
		List<com.liferay.software.catalog.model.SCProductVersion> scProductVersions) {
	...
	*/
	...
	private static ServiceTracker<SCFrameworkVersionPersistence, SCFrameworkVersionPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(SCFrameworkVersionUtil.class);

		_serviceTracker = new ServiceTracker<SCFrameworkVersionPersistence, SCFrameworkVersionPersistence>(bundle.getBundleContext(),
				SCFrameworkVersionPersistence.class, null);
