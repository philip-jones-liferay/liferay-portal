...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=sc", "json.web.service.context.path=SCProductEntry"}, service = SCProductEntryService.class)
@ProviderType
...
public interface SCProductEntryService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SCProductEntryServiceUtil} to access the s c product entry remote service. Add custom service methods to {@link com.liferay.software.catalog.service.impl.SCProductEntryServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
