...
public interface SCProductEntryLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SCProductEntryLocalServiceUtil} to access the s c product entry local service. Add custom service methods to {@link com.liferay.software.catalog.service.impl.SCProductEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	@com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
	public com.liferay.software.catalog.model.SCProductEntry addProductEntry(
	...
	public void addProductEntryResources(
		com.liferay.software.catalog.model.SCProductEntry productEntry,
	...
	*/
	@com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
	public com.liferay.software.catalog.model.SCProductEntry addSCProductEntry(
		com.liferay.software.catalog.model.SCProductEntry scProductEntry);
	...
	*/
	public com.liferay.software.catalog.model.SCProductEntry createSCProductEntry(
		long productEntryId);
	...
	*/
	...
	public com.liferay.software.catalog.model.SCProductEntry deleteProductEntry(
		com.liferay.software.catalog.model.SCProductEntry productEntry)
		throws PortalException;
	...
	*/
	@com.liferay.portal.kernel.search.Indexable(type = IndexableType.DELETE)
	public com.liferay.software.catalog.model.SCProductEntry deleteSCProductEntry(
		long productEntryId) throws PortalException;
	...
	*/
	...
	public com.liferay.software.catalog.model.SCProductEntry fetchSCProductEntry(
		long productEntryId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<com.liferay.software.catalog.model.SCProductEntry> getCompanyProductEntries(
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<com.liferay.software.catalog.model.SCProductEntry> getProductEntries(
		long groupId, int start, int end);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<com.liferay.software.catalog.model.SCProductEntry> getProductEntries(
		long groupId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.software.catalog.model.SCProductEntry> obc);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<com.liferay.software.catalog.model.SCProductEntry> getSCLicenseSCProductEntries(
		long licenseId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<com.liferay.software.catalog.model.SCProductEntry> getSCProductEntries(
		int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public com.liferay.software.catalog.model.SCProductEntry getSCProductEntry(
		long productEntryId) throws PortalException;
	...
	@com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
	public com.liferay.software.catalog.model.SCProductEntry updateProductEntry(
	...
	*/
	@com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
	public com.liferay.software.catalog.model.SCProductEntry updateSCProductEntry(
		com.liferay.software.catalog.model.SCProductEntry scProductEntry);
}