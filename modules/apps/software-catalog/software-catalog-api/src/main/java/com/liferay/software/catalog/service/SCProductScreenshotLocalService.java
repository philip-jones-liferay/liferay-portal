...
public interface SCProductScreenshotLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SCProductScreenshotLocalServiceUtil} to access the s c product screenshot local service. Add custom service methods to {@link com.liferay.software.catalog.service.impl.SCProductScreenshotLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public com.liferay.software.catalog.model.SCProductScreenshot addSCProductScreenshot(
	...
	*/
	public com.liferay.software.catalog.model.SCProductScreenshot createSCProductScreenshot(
	...
	*/
	...
	public com.liferay.software.catalog.model.SCProductScreenshot deleteSCProductScreenshot(
	...
	*/
	...
	public com.liferay.software.catalog.model.SCProductScreenshot fetchSCProductScreenshot(
		long productScreenshotId);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public com.liferay.software.catalog.model.SCProductScreenshot getProductScreenshot(
		long productEntryId, int priority) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public com.liferay.software.catalog.model.SCProductScreenshot getProductScreenshotByFullImageId(
		long fullImageId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public com.liferay.software.catalog.model.SCProductScreenshot getProductScreenshotByThumbnailId(
		long thumbnailId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<com.liferay.software.catalog.model.SCProductScreenshot> getProductScreenshots(
		long productEntryId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public com.liferay.software.catalog.model.SCProductScreenshot getSCProductScreenshot(
		long productScreenshotId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<com.liferay.software.catalog.model.SCProductScreenshot> getSCProductScreenshots(
		int start, int end);
	...
	*/
	@com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
	public com.liferay.software.catalog.model.SCProductScreenshot updateSCProductScreenshot(
		com.liferay.software.catalog.model.SCProductScreenshot scProductScreenshot);
}