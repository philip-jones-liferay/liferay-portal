...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=sc", "json.web.service.context.path=SCFrameworkVersion"}, service = SCFrameworkVersionService.class)
@ProviderType
...
public interface SCFrameworkVersionService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SCFrameworkVersionServiceUtil} to access the s c framework version remote service. Add custom service methods to {@link com.liferay.software.catalog.service.impl.SCFrameworkVersionServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
