 ...
 * {@link com.liferay.software.catalog.service.impl.SCProductScreenshotLocalServiceImpl} and is the
 ...
 * @see com.liferay.software.catalog.service.base.SCProductScreenshotLocalServiceBaseImpl
 * @see com.liferay.software.catalog.service.impl.SCProductScreenshotLocalServiceImpl
 * @generated
 */
@ProviderType
public class SCProductScreenshotLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.software.catalog.service.impl.SCProductScreenshotLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.software.catalog.model.SCProductScreenshot addSCProductScreenshot(
		com.liferay.software.catalog.model.SCProductScreenshot scProductScreenshot) {
	...
	*/
	public static com.liferay.software.catalog.model.SCProductScreenshot createSCProductScreenshot(
	...
	*/
	...
	public static void deleteProductScreenshot(
		com.liferay.software.catalog.model.SCProductScreenshot productScreenshot)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static com.liferay.software.catalog.model.SCProductScreenshot deleteSCProductScreenshot(
		long productScreenshotId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	...
	public static com.liferay.software.catalog.model.SCProductScreenshot fetchSCProductScreenshot(
		long productScreenshotId) {
	...
	*/
	...
	public static com.liferay.software.catalog.model.SCProductScreenshot getProductScreenshot(
		long productEntryId, int priority)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getProductScreenshot(productEntryId, priority);
	}

	public static com.liferay.software.catalog.model.SCProductScreenshot getProductScreenshotByFullImageId(
		long fullImageId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getProductScreenshotByFullImageId(fullImageId);
	}

	public static com.liferay.software.catalog.model.SCProductScreenshot getProductScreenshotByThumbnailId(
		long thumbnailId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getProductScreenshotByThumbnailId(thumbnailId);
	}

	public static java.util.List<com.liferay.software.catalog.model.SCProductScreenshot> getProductScreenshots(
		long productEntryId) {
	...
	* @throws PortalException if a s c product screenshot with the primary key could not be found
	*/
	public static com.liferay.software.catalog.model.SCProductScreenshot getSCProductScreenshot(
		long productScreenshotId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<com.liferay.software.catalog.model.SCProductScreenshot> getSCProductScreenshots(
		int start, int end) {
	...
	*/
	public static com.liferay.software.catalog.model.SCProductScreenshot updateSCProductScreenshot(
		com.liferay.software.catalog.model.SCProductScreenshot scProductScreenshot) {
	...
	private static ServiceTracker<SCProductScreenshotLocalService, SCProductScreenshotLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(SCProductScreenshotLocalServiceUtil.class);

		_serviceTracker = new ServiceTracker<SCProductScreenshotLocalService, SCProductScreenshotLocalService>(bundle.getBundleContext(),
				SCProductScreenshotLocalService.class, null);
