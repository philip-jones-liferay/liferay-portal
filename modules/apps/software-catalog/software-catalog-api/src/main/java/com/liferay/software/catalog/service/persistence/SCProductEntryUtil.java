 ...
 * @see com.liferay.software.catalog.service.persistence.impl.SCProductEntryPersistenceImpl
 * @generated
 */
@ProviderType
public class SCProductEntryUtil {
	...
	* @throws com.liferay.software.catalog.NoSuchProductEntryException if a matching s c product entry could not be found
	*/
	public static SCProductEntry findByGroupId_First(long groupId,
		OrderByComparator<SCProductEntry> orderByComparator)
		throws com.liferay.software.catalog.exception.NoSuchProductEntryException {
	...
	* @throws com.liferay.software.catalog.NoSuchProductEntryException if a s c product entry with the primary key could not be found
	*/
	...
	*/
	...
	/**
	* Returns the s c product entry where repoGroupId = &#63; and repoArtifactId = &#63; or throws a {@link com.liferay.software.catalog.NoSuchProductEntryException} if it could not be found.
	*
	...
	*/
	...
	/**
	* Returns the s c product entry with the primary key or throws a {@link com.liferay.software.catalog.NoSuchProductEntryException} if it could not be found.
	*
	* @param productEntryId the primary key of the s c product entry
	...
	*/
	public static List<com.liferay.software.catalog.model.SCLicense> getSCLicenses(
		long pk) {
	...
	*/
	public static List<com.liferay.software.catalog.model.SCLicense> getSCLicenses(
		long pk, int start, int end,
		OrderByComparator<com.liferay.software.catalog.model.SCLicense> orderByComparator) {
	...
	*/
	public static void addSCLicenses(long pk,
		List<com.liferay.software.catalog.model.SCLicense> scLicenses) {
	...
	*/
	...
	private static ServiceTracker<SCProductEntryPersistence, SCProductEntryPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(SCProductEntryUtil.class);

		_serviceTracker = new ServiceTracker<SCProductEntryPersistence, SCProductEntryPersistence>(bundle.getBundleContext(),
				SCProductEntryPersistence.class, null);
