 ...
 * @see com.liferay.software.catalog.service.persistence.impl.SCLicensePersistenceImpl
 * @generated
 */
@ProviderType
public class SCLicenseUtil {
	...
	* @throws com.liferay.software.catalog.NoSuchLicenseException if a matching s c license could not be found
	*/
	public static SCLicense findByActive_First(boolean active,
		OrderByComparator<SCLicense> orderByComparator)
		throws com.liferay.software.catalog.exception.NoSuchLicenseException {
	...
	* @throws com.liferay.software.catalog.NoSuchLicenseException if a s c license with the primary key could not be found
	*/
	...
	*/
	...
	/**
	* Returns the s c license with the primary key or throws a {@link com.liferay.software.catalog.NoSuchLicenseException} if it could not be found.
	*
	* @param licenseId the primary key of the s c license
	...
	*/
	public static List<com.liferay.software.catalog.model.SCProductEntry> getSCProductEntries(
		long pk) {
	...
	*/
	public static List<com.liferay.software.catalog.model.SCProductEntry> getSCProductEntries(
		long pk, int start, int end,
		OrderByComparator<com.liferay.software.catalog.model.SCProductEntry> orderByComparator) {
		return getPersistence()
	...
	*/
	public static void addSCProductEntries(long pk,
		List<com.liferay.software.catalog.model.SCProductEntry> scProductEntries) {
	...
	*/
	...
	private static ServiceTracker<SCLicensePersistence, SCLicensePersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(SCLicenseUtil.class);

		_serviceTracker = new ServiceTracker<SCLicensePersistence, SCLicensePersistence>(bundle.getBundleContext(),
				SCLicensePersistence.class, null);
