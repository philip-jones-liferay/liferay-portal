...
public class SCFrameworkVersionServiceHttp {
	public static com.liferay.software.catalog.model.SCFrameworkVersion addFrameworkVersion(
		...
		try {
			...
			return (com.liferay.software.catalog.model.SCFrameworkVersion)returnObj;
		}
	...
	public static java.util.List<com.liferay.software.catalog.model.SCFrameworkVersion> getFrameworkVersions(
		...
		try {
			...
			return (java.util.List<com.liferay.software.catalog.model.SCFrameworkVersion>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
