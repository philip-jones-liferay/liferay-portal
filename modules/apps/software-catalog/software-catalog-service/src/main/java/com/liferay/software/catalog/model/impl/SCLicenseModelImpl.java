...
import com.liferay.software.catalog.model.SCLicenseModel;
import com.liferay.software.catalog.model.SCLicenseSoap;
...
public class SCLicenseModelImpl extends BaseModelImpl<SCLicense>
	...
	public static final String TABLE_SQL_CREATE = "create table SCLicense (licenseId LONG not null primary key,companyId LONG,name VARCHAR(75) null,url VARCHAR(75) null,openSource BOOLEAN,active_ BOOLEAN,recommended BOOLEAN)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.software.catalog.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.software.catalog.model.SCLicense"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.software.catalog.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.software.catalog.model.SCLicense"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.software.catalog.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.liferay.software.catalog.model.SCLicense"),
			true);
	...
	public static final boolean FINDER_CACHE_ENABLED_SCLICENSES_SCPRODUCTENTRIES =
		GetterUtil.getBoolean(com.liferay.software.catalog.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.SCLicenses_SCProductEntries"),
			true);
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.software.catalog.service.util.ServiceProps.get(
				"lock.expiration.time.com.liferay.software.catalog.model.SCLicense"));
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.software.catalog.model.SCLicense");
