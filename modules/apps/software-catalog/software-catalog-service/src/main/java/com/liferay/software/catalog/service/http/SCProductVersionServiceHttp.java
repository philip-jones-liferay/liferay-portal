...
public class SCProductVersionServiceHttp {
	public static com.liferay.software.catalog.model.SCProductVersion addProductVersion(
		...
		try {
			...
			return (com.liferay.software.catalog.model.SCProductVersion)returnObj;
		}
	...
	public static java.util.List<com.liferay.software.catalog.model.SCProductVersion> getProductVersions(
		...
		try {
			...
			return (java.util.List<com.liferay.software.catalog.model.SCProductVersion>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
