...
import com.liferay.software.catalog.exception.NoSuchLicenseException;
import com.liferay.software.catalog.model.SCLicense;
import com.liferay.software.catalog.model.impl.SCLicenseImpl;
import com.liferay.software.catalog.model.impl.SCLicenseModelImpl;
 ...
 * @see com.liferay.software.catalog.service.persistence.SCLicenseUtil
 * @generated
 */
@ProviderType
public class SCLicensePersistenceImpl extends BasePersistenceImpl<SCLicense>
	 ...
	 */
	@Override
	public List<com.liferay.software.catalog.model.SCProductEntry> getSCProductEntries(
		long pk) {
	...
	public void addSCProductEntries(long pk,
		...
		for (com.liferay.software.catalog.model.SCProductEntry scProductEntry : scProductEntries) {
			scLicenseToSCProductEntryTableMapper.addTableMapping(0, pk,
				scProductEntry.getPrimaryKey());
		}
	}
	...
	protected TableMapper<SCLicense, com.liferay.software.catalog.model.SCProductEntry> scLicenseToSCProductEntryTableMapper;
