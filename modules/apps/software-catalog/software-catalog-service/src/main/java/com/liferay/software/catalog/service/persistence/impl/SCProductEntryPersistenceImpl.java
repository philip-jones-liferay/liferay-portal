...
import com.liferay.software.catalog.model.impl.SCProductEntryImpl;
import com.liferay.software.catalog.model.impl.SCProductEntryModelImpl;
import com.liferay.software.catalog.service.persistence.SCLicensePersistence;
 ...
 * @see com.liferay.software.catalog.service.persistence.SCProductEntryUtil
 * @generated
 */
@ProviderType
public class SCProductEntryPersistenceImpl extends BasePersistenceImpl<SCProductEntry>
	 ...
	 */
	@Override
	public List<com.liferay.software.catalog.model.SCLicense> getSCLicenses(
		long pk) {
	...
	public void addSCLicenses(long pk,
		...
		for (com.liferay.software.catalog.model.SCLicense scLicense : scLicenses) {
			scProductEntryToSCLicenseTableMapper.addTableMapping(0, pk,
				scLicense.getPrimaryKey());
		}
	}
	...
	public void setSCLicenses(long pk,
		...
		try {
			...
			for (int i = 0; i < scLicenses.size(); i++) {
				com.liferay.software.catalog.model.SCLicense scLicense = scLicenses.get(i);
	...
	protected TableMapper<SCProductEntry, com.liferay.software.catalog.model.SCLicense> scProductEntryToSCLicenseTableMapper;
