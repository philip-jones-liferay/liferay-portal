 ...
 * is translated to an array of {@link com.liferay.software.catalog.model.SCFrameworkVersionSoap}.
 * If the method in the service utility returns a
 * {@link com.liferay.software.catalog.model.SCFrameworkVersion}, that is translated to a
 * {@link com.liferay.software.catalog.model.SCFrameworkVersionSoap}. Methods that SOAP cannot
 ...
 * @see com.liferay.software.catalog.model.SCFrameworkVersionSoap
...
public class SCFrameworkVersionServiceSoap {
	...
	public static com.liferay.software.catalog.model.SCFrameworkVersionSoap[] getFrameworkVersions(
		long groupId, boolean active) throws RemoteException {
		try {
			java.util.List<com.liferay.software.catalog.model.SCFrameworkVersion> returnValue =
				SCFrameworkVersionServiceUtil.getFrameworkVersions(groupId,
					active);

			return com.liferay.software.catalog.model.SCFrameworkVersionSoap.toSoapModels(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
