...
public class SCLicenseModelImpl extends BaseModelImpl<SCLicense>
	...
	public static final String TABLE_SQL_CREATE = "create table SCLicense (licenseId LONG not null primary key,name VARCHAR(75) null,url VARCHAR(75) null,openSource BOOLEAN,active_ BOOLEAN,recommended BOOLEAN)";
